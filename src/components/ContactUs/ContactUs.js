...
const ContactUs = () => {
  ...
  return (
    <>
      ...
      <div>
        <h2>Didn t find what you needed? Let us know!</h2>
        <div>
          <div>
            <h1>Write to us!</h1>
        ...
        <div>
          <div>
            <img src={vector2} alt="left" />
          </div>
          <h3>Call Us: +91-8826791521</h3>
          <div>
            <div>
              {/* <img>icon</img> */}
              <p><b>Address</b>
